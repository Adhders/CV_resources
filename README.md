...
- [2019-CVPR] Bags of Tricks and A Strong Baseline for Deep Person Re-identification(Baseline) [`paper`](https://arxiv.org/abs/1903.07071) [`code`](https://github.com/michuanhaohao/reid-strong-baseline)
...
### Recommendation
- [`framework`] Implementation of Deep Learning based Recommender Algorithms with Tensorflow [`code`](https://github.com/cheungdaven/DeepRec)
...
- [2019-CVPR] PTSNet: Proposal, Tracking and Segmentation (PTS): A Cascaded Network for Video Object Segmentation [`paper`](https://arxiv.org/abs/1907.01203) [`code`](https://github.com/sydney0zq/PTSNet)
...
### Tool
- [`FrameWork`] Pretrained EfficientNet, MobileNetV3 V2 and V1, MNASNet A1 and B1, FBNet, ChamNet, Single-Path NAS [`code`](https://github.com/rwightman/gen-efficientnet-pytorch)
...
- [2019-CVPR] Libra R-CNN: Towards Balanced Learning for Object Detection [`paper`](https://arxiv.org/pdf/1904.02701.pdf) [`code`](https://github.com/OceanPang/Libra_R-CNN)
...
### Body Related Recognition & Detection

 - [`collection`] Face Benchmark and Dataset [`code`](https://github.com/becauseofAI/HelloFace)
 - [`Framwork`]  A face recognition solution on mobile device [`code`](https://github.com/becauseofAI/MobileFace)
 ...
 - [2019-CVPR] C3AE: Exploring the Limits of Compact Modelfor Age Estimation [`paper`](https://arxiv.org/abs/1904.05059)
 ...
 - [2019-CVPR] MVF-Net: Multi-View 3D Face Morphable Model Regression(face reconstructing) [`paper`](MVF-Net: Multi-View 3D Face Morphable Model Regression) [`code`](https://github.com/Fanziapril/mvfnet)


 

### Data Augmentation 
- [`skill`] upscale and improve the quality of low resolution images [`code`](https://github.com/idealo/image-super-resolution) 
- [`skill`] A Python Package to Tackle the Curse of Imbalanced Datasets in Machine Learning [`code`](https://github.com/scikit-learn-contrib/imbalanced-learn)
...
- [2019-CVPR] Image-to-Image Translation via Group-wise Deep Whitening-and-Coloring Transformation(Image Translation) [`paper`](https://arxiv.org/abs/1812.09912) [`code`](https://github.com/taki0112/GDWCT-Tensorflow)
...
- [`Framework`] Semantic Segmentation in Pytorch [`code`](https://github.com/hszhao/semseg)
- [`FrameWork`] Semantic Segmentation on PyTorch (include FCN, PSPNet, Deeplabv3, DANet, DenseASPP, BiSeNet, EncNet, DUNet, ICNet, ENet, OCNet, CCNet, PSANet, CGNet, ESPNet, LEDNet) [`code`](https://github.com/Tramac/awesome-semantic-segmentation-pytorch) 
- [`FrameWork`] Segmentation models with pretrained backbones [`code`](https://github.com/qubvel/segmentation_models)
...
- [2019-CVPR] Locating Objects Without Bounding Boxes [`paper`](https://arxiv.org/pdf/1806.07564.pdf)(***crowd count) [`code`](https://github.com/javiribera/locating-objects-without-bboxes)
...
- [2019-CVPR] Detect-to-Retrieve: Efficient Regional Aggregation for Image Search [`paper`](https://arxiv.org/abs/1812.01584) [`code`](https://github.com/tensorflow/models/tree/master/research/delf)
- [2019-CVPR] DFPN: Efficient Object Detection Model for Real-Time UAV Applications [`paper`](https://arxiv.org/abs/1906.00786)
...
- [2019-CVPR] Domain Adaptation(reducing the domain shif) [`paper`](http://openaccess.thecvf.com/content_CVPR_2019/papers/Luo_Taking_a_Closer_Look_at_Domain_Shift_Category-Level_Adversaries_for_CVPR_2019_paper.pdf) [`code`](https://github.com/RoyalVane/CLAN)
...
- [2019-CVPR] Graph Convolutional Tracking(Oral) [`code`](http://nlpr-web.ia.ac.cn/mmc/homepage/jygao/gct_cvpr2019.html#)
...
- [2019-CVPR] Monocular 3D Object Detection and Box Fitting Trained End-to-End Using Intersection-over-Union Loss [`paper`](https://arxiv.org/abs/1906.08070) 
- [2019-CVPR] MMDetection: Open MMLab Detection Toolbox and Benchmark [`paper`](https://arxiv.org/abs/1906.07155) [`code`](https://github.com/open-mmlab/mmdetection)
- [2019-CVPR] YOLOv3+: Assisted Excitation of Activations: A Learning Technique to Improve Object Detectors [`paper`](https://arxiv.org/abs/1906.05388) 
...
- [2019-Github] multi-people tracking (centerNet based person detector + deep sort algorithm with pytorch) [`code`](https://github.com/kimyoon-young/centerNet-deep-sort)
...
- [2019-CVPR] Monocular Total Capture: Posing Face, Body, and Hands in the Wild(gestrue catpture) [`paper`](https://arxiv.org/abs/1812.01598) [`code`](https://github.com/CMU-Perceptual-Computing-Lab/MonocularTotalCapture)
